...
},{"./components/navbars":2,"./components/album":3,"./settings":4,"./router":5}],4:[function(require,module,exports){
module.exports = {
    appId: "",
    pageId: "",
...
},{"./pages/splash":6,"./pages/albums":7,"./settings":4,"./helper":8}],2:[function(require,module,exports){
// Header component
...
},{"../components/progressLoader":9,"../components/photos":10,"../models":11}],8:[function(require,module,exports){
module.exports = {
    Observable:  function() {
        var channels = {}
        return {
...
},{"./settings":4,"./helper":8}],6:[function(require,module,exports){
...
},{"../components/fbLogin":12}],7:[function(require,module,exports){
var progressLoader = require('../components/progressLoader');
var albumComponent = require('../components/album');
...
},{"../components/progressLoader":9,"../components/album":3,"../services":13,"../models":11}],10:[function(require,module,exports){
var Storage = require('../helper').storage;
var userId = Storage('userId');
...
},{"./settings":4,"./helper":8}],12:[function(require,module,exports){
var Services = require('../services');
var Storage = require('../helper').storage;
